...
\begin{esamebox}
\emph{``Descrivere le fasi che compongono un ciclo del browser, a partire da quando esso
ottiene una pagina HTML in risposta a una precedente transazione HTTP.''}
\end{esamebox}
...
\begin{esamebox}
\emph{``Spiegare la differenza concettuale fra la distinzione client-side/server-side e la
distinzione front-end/back-end.''}
\end{esamebox}
